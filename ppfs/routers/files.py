...
async def get_file_content(id: ObjectId = Depends(get_id), files: Files = Depends(get_file_factory)):
...
async def rename_file(new_name: str, id: ObjectId = Depends(get_id), files: Files = Depends(get_file_factory)):
...
async def delete_file(id: ObjectId = Depends(get_id), files: Files = Depends(get_file_factory)):
